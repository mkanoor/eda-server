...
def inputs_to_display(schema: dict, inputs: str, section: str="fields") -> dict:
...
def add_default_values_to_user_inputs(schema: dict, inputs: dict, section: str = "fields") -> dict:
    for field in schema.get(section, []):
        key = field.get("id")
